      ...
      <div id ='audioPanel' className='panel panel-default'>
        ...
        <div>
          {isAuthorized && !this.state.isRecording &&
            <button className='btn btn-primary rec-btn btn-sm' onClick={this._onStartLiveStreamClick.bind(this)}><i className='fa fa-microphone'></i>&ensp;Start Recording</button>
          }
          {isAuthorized && this.state.isRecording &&
            <button className='btn btn-primary rec-btn btn-sm disabled'><i className='fa fa-microphone'></i>&ensp;Start Recording</button>
          }
          {isAuthorized && this.state.isRecording &&
            <button className='btn btn-primary rec-btn btn-sm' onClick={this._onStopLiveStreamClick.bind(this)}><i className='fa fa-stop-circle'></i>&ensp;Stop Recording</button>
          }
          {isAuthorized && !this.state.isRecording &&
            <button className='btn btn-primary rec-btn btn-sm disabled'><i className='fa fa-stop-circle'></i>&ensp;Stop Recording</button>
          }
        </div>
